                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildSection(
                      ...
                      content:
                          'باستخدامك تطبيق "مدرستي"، فإنك تقبل وتوافق على الالتزام بهذه الشروط والأحكام. إذا كنت لا توافق على أي جزء من هذه الشروط، فيرجى عدم استخدام التطبيق.',
                    ),
                    const SizedBox(height: 20),
                    _buildSection(
                      title: '2. استخدام التطبيق',
                      content:
                          'يُسمح لك باستخدام تطبيق "مدرستي" للأغراض التعليمية فقط. يجب عليك استخدام التطبيق بطريقة قانونية ووفقاً لهذه الشروط. يُمنع استخدام التطبيق لأي غرض غير قانوني أو غير مصرح به.',
                    ),
                    const SizedBox(height: 20),
                    _buildSection(
